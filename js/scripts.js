	...
	$("#cform").validate({
		...
		submitHandler: function() {
			$.ajax({
				...
				type: 'post',
				dataType: 'json',
				data: 'apikey=5045A753C8197708EA67A3294B74F4E2ED046745AE2899584B31F2FDA80E2864CCD0C829460A6EDE381B5AD71AD3EC09 &from Name=Nirav Gandhi&from=i3testnirav@gmail.com&senderName='+ $("#cform").find('input[name="name"]').val() + '&sender='+ $("#cform").find('input[name="email"]').val() + '&bodyText=' + $("#cform").find('textarea[name="message"]').val() + '&subject=My Portfolio Connect &to=portfolio@niravjgandhi.com&isTransactional=true',
				beforeSend: function() {
...
function initMap() {
	var myLatlng = new google.maps.LatLng(23.186637,72.620442); // <- Your latitude and longitude
	var styles = [
	{
		"featureType": "water",
		"stylers": [{
